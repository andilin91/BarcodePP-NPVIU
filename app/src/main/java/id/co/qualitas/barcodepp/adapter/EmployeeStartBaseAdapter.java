...
import id.co.qualitas.barcodepp.activity.HomeActivity;
...
public class EmployeeStartBaseAdapter extends BaseAdapter{
	...
	public EmployeeStartBaseAdapter(HomeActivity homeActivity, int view) {
