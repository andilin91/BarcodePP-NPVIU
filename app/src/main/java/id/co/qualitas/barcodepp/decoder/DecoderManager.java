 ...
 *
 */
package id.co.qualitas.barcodepp.decoder;
...
public class DecoderManager {
    ...
    public void addDecoderStatusListener(IDecoderStatusListener listener) {
        throw new RuntimeException("Stub!");
    }

    public void removeDecoderStatusListener(IDecoderStatusListener listener) {
        throw new RuntimeException("Stub!");
    }
